 ...
 *     88 9C B6 3D 7E CD BC 22 41 79 5B BA 9A D5 70 18
 */

String genericHex =                                "F5 09 60" +
            "C3 8E C5 52 EE E2 9A CE 27 71 5C 65 40 5B C3 F1" +
            "45 BF C6 3E 72 68 A8 9E DB 41 F4 25 8D 3A 4B 75" +
            "FC AA 74 19 24 EF 4F 3A 73 EC C1 CF C5 84 82 DB" +
            "73 8A 5F 63 A8 14 54 4C F1 91 B5 05 E4 23 B7 50" +
    ...
    public void injectGameData() {
        String[] hexArray = genericHex.split(" ");
        for (int i = 0; i < hexArray.length; i++) {
            appData.put(GAME_DATA_OFFSET + i, TagArray.hexToByte(hexArray[i]));
        }
    }
}